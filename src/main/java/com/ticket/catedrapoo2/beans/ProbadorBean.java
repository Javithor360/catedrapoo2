...
public class ProbadorBean {

    // Obtener todos tickets asignados
    public HashMap<String, Ticket> fetchTickets(int tester_id) throws SQLException {
    ...
    // Registro si dado caso se niega el ticket
    public void rejectLog (String ticket_code, String title, String desc, Float percent, int tester_id) throws SQLException {
        Conexion conexion = new Conexion();
        PreparedStatement stmt;

        String query = "INSERT INTO ticket_logs " +
                "(code_ticket, name, description, percent, programmer_id) " +
                "VALUES (\"" + ticket_code + "\", \"" + title + "\", \"" + desc + "\", " + percent + ", " + tester_id + ");";
    ...
    public void updateStateTicket(int newState, int ticketId, int testerId) throws SQLException{
        Conexion conexion = new Conexion();
        PreparedStatement stmt;
    ...
    // Actualizar fecha de entrega del ticket
    public void updateDateTicket(String newDate, int ticketId) throws SQLException{
        Conexion conexion = new Conexion();
        PreparedStatement stmt;
