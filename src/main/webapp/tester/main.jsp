...
<head>
    ...
    <title>Empleado de área funcional - Main</title>
</head>
<body>
    ...
    <main class="container mt-3">
        <div>
            ...
            <p class="small"> Empleado de área funcional</p>
        </div>
                ...
                <table class="table table-striped table-bordered text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/tester/detail.jsp?&id=<%= ticket.getId() %>" class="btn btn-primary">Ver</a>
                        </td>
                    </tr>
                    <%
                            }
